  ...
  <LegalPage title="Terms and Conditions of Use">
    ...
    <ol type="a">
      <li>
        ...
        materials (information or software) on Onolog's web site for
        ...
        <ol type="i">
          ...
          <li>
            ...
            contained on Onolog's web site;
          </li>
          <li>
      ...
      <li>
        ...
        these restrictions and may be terminated by Onolog at any time.
    ...
    <h3>3. Disclaimer</h3>
    <p>
      The materials on Onolog's web site are provided "as is". Onolog
      makes no warranties, expressed or implied, and hereby disclaims
      and negates all other warranties, including without limitation,
      implied warranties or conditions of merchantability, fitness for a
      particular purpose, or non-infringement of intellectual property
      or other violation of rights. Further, Onolog does not warrant or
    ...
    <h3>4. Limitations</h3>
    <p>
      In no event shall Onolog or its suppliers be liable for any
      damages (including, without limitation, damages for loss of data
      or profit, or due to business interruption,) arising out of the
      use or inability to use the materials on Onolog's Internet site,
      even if Onolog or a Onolog authorized representative has been
    ...
    <p>
      ...
      technical, typographical, or photographic errors. Onolog does not
      warrant that any of the materials on its web site are accurate,
      complete, or current. Onolog may make changes to the materials
      contained on its web site at any time without notice. Onolog does
      not, however, make any commitment to update the materials.
    </p>

    <h3>6. Links</h3>
    <p>
      Onolog has not reviewed all of the sites linked to its Internet
      ...
      by Onolog of the site. Use of any such linked web site is at the
      user's own risk.
    </p>

    <h3>7. Site Terms of Use Modifications</h3>
    <p>
      Onolog may revise these terms of use for its web site at any time
    ...
    <p>
      Any claim relating to Onolog's web site shall be governed by the
